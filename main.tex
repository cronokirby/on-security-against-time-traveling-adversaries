...
\begin{abstract}
    ...
    We look at the impacts of time travel on encryption and signatures,
...
This is enough to break many schemes, and yet it's possible to
design cryptography which resists quantum attacks.
...
can travel, and how deep they can travel in forked timelines,
...
the notion of time travel might seem practically irrelevant to
cryptography.
We think this that might not be the case.
...
the system needs to satisfy a higher level of encryption, in order to withstand
...
adversaries are effectively time traveling adversaries.
...
the notion of \emph{abstract game}, which allows us to encapsulate
